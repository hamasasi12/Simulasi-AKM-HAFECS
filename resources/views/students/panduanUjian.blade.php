...
<div class="min-h-screen py-8 px-4">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg mb-6">
            <div class="p-6">
                <h2 class="text-xl font-bold text-gray-800 mb-6 flex items-center">
                    <span class="bg-blue-600 text-white w-8 h-8 rounded-full flex items-center justify-center text-sm mr-3">!</span>
                    Petunjuk Penting
                </h2>
        ...
        <div class="bg-white rounded-xl shadow-lg">
            <div class="p-6">
                <form id="startExamForm" action="#" method="POST">
                    @csrf
                    <input type="hidden" name="category" value="asdsad">
                    ...
                    <div class="mb-6">
                        <label class="flex items-start space-x-3 cursor-pointer">
                            ...
                            <span class="text-sm text-gray-700">
                                Saya telah membaca dan memahami semua instruksi di atas, serta bersedia mengikuti peraturan ujian yang berlaku.
                            </span>
                        </label>
                    </div>
