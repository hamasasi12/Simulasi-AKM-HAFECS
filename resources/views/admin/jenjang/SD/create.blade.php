...
@section('content')
    <div class="max-w-5xl mx-auto px-4 pt-6 mt-4">
        ...
        <div class="bg-white border border-gray-100 rounded-xl shadow-md overflow-hidden">
            ...
            <!-- Form body -->
            <div class="p-2">
                <form action="{{ route('admin.dashboard.jenjang.sd.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="category_id" name="category_id" onchange="showCustomInput()"
                                            ...
                                            <option value="1">SD_LITERASI</option>
                                            <option value="2">SD_NUMERASI</option>
                                        </select>
                                    </div>
