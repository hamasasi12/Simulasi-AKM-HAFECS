    ...
    <div class="p-4 bg-white rounded-lg mb-2">
        <nav class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mt-4 text-base">
            ...
            <div class="flex flex-wrap items-center gap-3">
                <!-- Search -->
                <form action="{{ route('admin.dashboard.jenjang.sma.index') }}" method="GET"
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('admin.dashboard.jenjang.sma.create') }}" data-popover-target="popover-addUser"
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                <div class="flex space-x-2">
                                    <!-- View -->
                                    <a href="{{ route('admin.dashboard.jenjang.sma.show', $index->id) }}"
                                    ...
                                    <!-- Edit -->
                                    <a href="{{ route('admin.dashboard.jenjang.sma.edit', $index->id) }}"
                                    ...
                                    <!-- Delete -->
                                    <form action="{{ route('admin.dashboard.jenjang.sma.delete', $index->id) }}"
                    ...
                    @empty
                        @livewire('empty-state', [
                            ...
                            'message' => 'Data Soal Jenjang SMA belum tersedia.',
                            'colspan' => 6,
                            'showButton' => false,
                        ])
                    @endforelse
