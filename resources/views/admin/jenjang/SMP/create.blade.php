...
@section('content')
    <div class="max-w-5xl mx-auto px-4 pt-6 mt-4">
        ...
        <div class="bg-white border border-gray-100 rounded-xl shadow-md overflow-hidden">
            ...
            <!-- Form body -->
            <div class="p-2">
                <form action="{{ route('admin.dashboard.jenjang.smp.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="category_id" name="category_id" onchange="showCustomInput()"
                                            ...
                                            <option value="3">SMP_LITERASI</option>
                                            <option value="4">SMP_NUMERASI</option>
                                        </select>
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="file" name="image" id="image"
                                        ...
                                        <p class="text-sm">Ukuran gambar maksimal 2 MB (2048 KB).</p>
